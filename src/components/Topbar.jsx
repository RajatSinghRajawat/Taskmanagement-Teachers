      ...
      <div className="flex items-center gap-4 lg:gap-8">
        ...
        <div className="hidden sm:flex flex-col items-end mr-2">
          ...
          <h2 className="text-sm font-bold text-slate-800 font-display">
            {new Date().getHours() < 12 ? 'Good Morning' : new Date().getHours() < 17 ? 'Good Afternoon' : 'Good Evening'}, <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-600 to-purple-600">{user?.name ? user.name.split(' ')[0] : 'Teacher'} Sir</span>
          </h2>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          >
            <motion.div 
              ...
              className="h-11 w-11 rounded-2xl bg-gradient-to-tr from-indigo-500 to-purple-600 p-0.5 shadow-md relative"
            >
